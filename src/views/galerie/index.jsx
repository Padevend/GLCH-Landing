...
const Images_assets = Object.values(import.meta.glob('../../assets/gallery/*.{jpg,png,jpeg,webp}', {
    eager: true,
    query: '?url',
    import: 'default'
}))
...
export default function Galerie() {
  ...
  const prevImage = (e) => {
    e?.stopPropagation();
    setCurrentIndex((prev) => (prev - 1 + Images_assets.length) % Images_assets.length);
  };
      ...
      <section className="relative h-[40vh] md:h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-6 lg:px-24 relative z-10">
          ...
          <h1 className="text-white text-5xl md:text-7xl font-black tracking-tight mb-4">
            OUR <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-200 to-white">GALLERY</span>
          </h1>
          <p className="text-violet-100 text-lg md:text-2xl font-light italic max-w-2xl">
            "Capturing moments of hope, healing, and community strength since 2021."
          </p>
        </div>
      </section>
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-violet-900/80 via-violet-900/20 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300 flex flex-col justify-end p-6">
                  <div className="translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                    ...
                    <div className="flex items-center justify-between">
                      <h3 className="text-white font-bold text-lg">Community Outreach</h3>
          ...
          >
            ...
            <div className="mt-8 flex flex-col md:flex-row items-center justify-between w-full max-w-4xl gap-4">
              <div className="text-center md:text-left">
                <h4 className="text-white text-2xl font-bold">Community Health Event</h4>
                <p className="text-gray-400 text-sm">Yaoundé, Cameroon • October 2023</p>
              </div>
